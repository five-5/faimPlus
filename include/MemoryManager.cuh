...
size_t MemoryManager::numberEdgesInMemory(vertex_t* d_neighbours_count, bool return_count)
{
	...
	// d_neighbours_cout赋值
	faimGraphMemoryManager::d_reportEdges<VertexData> << < grid_size, block_size >> > ((MemoryManager*)d_memory, d_data, d_neighbours_count);
...
size_t MemoryManager::numberEdgesInMemory(vertex_t* d_neighbours_count, vertex_t vertex_offset, vertex_t number_vertices, bool return_count)
{
	...
	faimGraphMemoryManager::d_reportEdges<VertexData> << < grid_size, block_size >> > ((MemoryManager*)d_memory, d_data, d_neighbours_count, vertex_offset, number_vertices);
...
void MemoryManager::numberPagesInMemory(vertex_t* d_page_count)
{
	...
	faimGraphMemoryManager::d_reportPages<VertexData> << < grid_size, block_size >> > ((MemoryManager*)d_memory, d_data, d_page_count);
}
